...
```
bash <(curl -Ls https://raw.githubusercontent.com/AliCl0ner/3x-ui/refs/tags/v2.6.0/install.sh)
```
...
wget https://github.com/MHSanaei/AliCl0ner/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
